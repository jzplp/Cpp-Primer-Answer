...
public:
	...
	Sales_data(const std::string &s) noexcept : ISBN(s) { }
	Sales_data(const std::string &s, int a, double t) noexcept : ISBN(s), amount(a), totalPrice(t * a) { } 
	Sales_data(std::istream &is) noexcept { is >> *this; }
